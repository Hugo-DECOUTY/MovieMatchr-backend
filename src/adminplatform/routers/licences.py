...
from adminplatform.controller.licences.get_licences_from_order import (
    get_licences_from_order,
)
from adminplatform.controller.licences.patch_user_licence import patch_user_licence
