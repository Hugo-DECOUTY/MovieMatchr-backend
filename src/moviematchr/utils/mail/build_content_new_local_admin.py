...
from moviematchr.utils.emailStyle.email_style import EMAIL_STYLE

load_dotenv()

MICROPORT_CRM_LOGO = os.getenv("MICROPORT_CRM_LOGO")
MYRHYTHM_TICKET = os.getenv("MYRHYTHM_TICKET")


async def build_content_new_local_admin(
    name: str,
    email: str,
    password: str,
):
        ...
        <body width="100%" style="margin: 0; padding: 0 !important; background: #f3f3f5; mso-line-height-rule: exactly;">
            ...
            <![endif]-->
                ...
                <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
                    New account : Local Administrator
                </div>
                                    ...
                                    <tr>
                                        <td style="padding-bottom: 15px; font-family: arial, sans-serif; font-size: 15px; line-height: 21px; color: #3C3F44; text-align: left;">
                                            ...
                                            <p style="margin: 0 0 15px;">
                                                Hello {name}, you have been added to the Microport platform !
                                            </p>

                                            <p style="margin: 0 0 15px;">
                                                Please <a href="{MYRHYTHM_TICKET}" style="color: #007bff; text-decoration: none;">click here</a> or paste the link below
                                                to connect to your account with your new password.
                                            </p>
