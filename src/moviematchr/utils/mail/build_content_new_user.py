...
SYNESCOPE_WEB = os.getenv("SYNESCOPE_WEB")


async def build_content_new_user(
    name: str,
    email: str,
    password: str,
):
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                                    ...
                                    <tr>
                                        <td style="padding-bottom: 15px; font-family: arial, sans-serif; font-size: 15px; line-height: 21px; color: #3C3F44; text-align: left;">
                                            ...
                                            <p style="margin: 0 0 15px;">
                                                Please <a href="{SYNESCOPE_WEB}" style="color: #007bff; text-decoration: none;">click here</a> or paste the link below
